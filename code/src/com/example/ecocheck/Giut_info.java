...
public class Giut_info extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_giut_info);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_about:    // open about screen
			Intent intent = new Intent(Giut_info.this, About.class);
		...
		case R.id.action_to_main:
			Intent intent1 = new Intent(Giut_info.this, MainActivity.class);
	...
	public void onClickGI(View v) {
		String idB=(String) v.getTag();
		String  outFile = "/sdcard/GI/"+idB+".pdf";
		playSound(butS);
