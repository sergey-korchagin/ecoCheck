...
public class GoodData extends Activity {
	SoundPool soundPool;
	AssetManager assets;
	int butS;
	Context context;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_good_data);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_about:    // open about screen
			Intent intent = new Intent(GoodData.this, About.class);
		...
		case R.id.action_to_main:
			Intent intent1 = new Intent(GoodData.this, MainActivity.class);
	...
	public void onClickGD(View v) {
		String idB=(String) v.getTag();
		String  outFile = "/sdcard/GD/"+idB+".pdf";
		playSound(butS);
